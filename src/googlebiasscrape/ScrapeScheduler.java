...
/*public class ScrapeScheduler {
   ...
   public void run() throws Exception {
        ...
        JobDetail job = newJob(ScrapeIt.class).withIdentity("job1", "group1").build();
        ...
        Trigger trigger = newTrigger().withIdentity("trigger1", "group1").
                startNow().
                withSchedule(
                        simpleSchedule().withIntervalInSeconds(300)
                        .repeatForever()).build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        ScrapeScheduler querySched = new ScrapeScheduler();
